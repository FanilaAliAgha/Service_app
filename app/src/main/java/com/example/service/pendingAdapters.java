...
public class pendingAdapters extends ArrayAdapter<pending> {


    private Context mContext;
    private int mResource;
    public pendingAdapters(@NonNull Context context, int resource, @NonNull ArrayList<pending> objects) {
